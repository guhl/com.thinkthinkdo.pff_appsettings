...
public class PermissionListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<PFFSettingsContent.PFFSettingsContentItem>(getActivity(),
                R.layout.simple_list_item_activated_1,
                R.id.text1,
                PFFSettingsContent.ITEMS));
    }
    ...
    public void onListItemClick(ListView listView, View view, int position, long id) {
        ...
        mCallbacks.onItemSelected(PFFSettingsContent.ITEMS.get(position).id);
    }
